...
df['%พื้นที่ถนน'] = df.get('พื้นที่ถนนรวม(ตร.ม.)', 0) / df['พื้นที่โครงการ(ตรม)']
...
if submitted:
    ...
    ทาวโฮม = หลังรวม * pred[4] / (sum(pred[4:8]) or 1)
    บ้านแฝด = หลังรวม * pred[5] / (sum(pred[4:8]) or 1)
    บ้านเดี่ยว2 = หลังรวม * pred[6] / (sum(pred[4:8]) or 1)
    บ้านเดี่ยว3 = หลังรวม * pred[7] / (sum(pred[4:8]) or 1)
