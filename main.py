...
# คำนวณอัตราส่วนถนน/สาธารณะจากข้อมูลจริง
อัตราส่วน_ถนน_ต่อ_สาธารณะ = (df.get('พื้นที่ถนนรวม(ตร.ม.)', 0) / df.get('พื้นที่สาธา(ตรม)', 1)).replace([float('inf'), -float('inf')], pd.NA).dropna().mean()
df['%พื้นที่ถนน'] = df['%พื้นที่สาธา'] * อัตราส่วน_ถนน_ต่อ_สาธารณะ
