...
# -------------------- พื้นที่ถนน / สาธารณะ Ratio --------------------
ถนน_ต่อ_สาธา_series = df['พื้นที่ถนนรวม(ตร.ม.)'] / df['พื้นที่สาธา(ตรม)'].replace(0, 1)
เฉลี่ย_ถนน_ต่อ_สาธา = ถนน_ต่อ_สาธา_series[(ถนน_ต่อ_สาธา_series > 0) & (ถนน_ต่อ_สาธา_series < 5)].mean()
if pd.isna(เฉลี่ย_ถนน_ต่อ_สาธา):
