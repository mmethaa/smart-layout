...
if submitted:
    ...
    if err_dict:
        ...
        st.markdown(f"""
        - พื้นที่จัดจำหน่าย: **{format_err(err_dict['err_ขาย'])}**
        - พื้นที่สวน: **{format_err(err_dict['err_สวน'])}**
        - พื้นที่สาธารณะ: **{format_err(err_dict['err_สาธา'])}**
        - พื้นที่ถนน: **{format_err(err_dict['err_ถนน'])}**
        - จำนวนแปลงรวม: **{format_err(err_dict['err_แปลง'])}**
        - จำนวนซอย: **{format_err(err_dict['err_ซอย'])}**
        """)
# ==============================
# ค้นหาโครงการในอดีตที่ใกล้เคียงที่สุด
# ==============================
