...
if submitted:
    ...
    if not match_row.empty:
        ...
        err_dict['err_ขาย'] = err(พท_ขาย, พท_ขาย_จริง)
        err_dict['err_สาธา'] = err(พท_สาธา, พท_สาธา_จริง)
        err_dict['err_สวน'] = err(พท_สวน, พท_สวน_จริง)
        err_dict['err_ถนน'] = err(พท_ถนน, พท_ถนน_จริง)
        err_dict['err_แปลง'] = err(หลังรวม, หลัง_จริง)
        err_dict['err_ซอย'] = err(ซอย, ซอย_จริง)
    else:
        for key in ['err_ขาย', 'err_สาธา', 'err_สวน', 'err_ถนน', 'err_แปลง', 'err_ซอย']:
            err_dict[key] = None
